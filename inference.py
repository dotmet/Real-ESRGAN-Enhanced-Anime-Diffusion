...
if __name__ == "__main__":
    ...
    while True:
        ...
        #]
        prompt_keys = [
            random.choice(['1girl', ]), 'sky', 'detailed fingers',
            random.choice(['white hair', 'red hair', 'blonde hair', 'black hair', 'green hair', ]),
            'green eyes', 'nipples', 'spread_legs', 'M-shaped legs', 'spread_pussy',  
            'colorful', 'cumulonimbus clouds', 'lighting', 'blue sky', 
            random.choice(['flower meadow', 'garden', 'city', 'river', 'beach']),
        ]
        prompt_keys = '.'.join(prompt_keys)
        guidance = 7.5
        steps = 50
        # width = 1024
        # height = 1024
        ...
        strength = 0.5
        neg_prompt = ""
        inference(model_name, prompt_keys, guidance, steps, width=width, height=height, seed=seed, img=img,
